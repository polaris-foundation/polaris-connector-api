...
from dhos_connector_api.blueprint_api import api_blueprint
from dhos_connector_api.models.api_spec import dhos_connector_api_spec
...
def test_openapi(tmp_path: str, app: Flask, app_context: AppContext) -> None:
    ...
    generate_openapi_spec(dhos_connector_api_spec, new_spec_path, api_blueprint)

    new_spec = yaml.safe_load(new_spec_path.read_bytes())
    existing_spec = Path(__file__).parent / "../dhos_connector_api/openapi/openapi.yaml"
